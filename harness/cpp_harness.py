"""Harness for C++ benchmark sources (.cpp files)."""
...
class CppHarness(BaseHarness):
    ...
    def prepare(
        ...
        compiler_key = target_spec.get("compiler_key", "cpp_compiler")
        ...
        compile_args = list(target_spec.get("compile_args", ["-O3", "-std=c++20"]))
