...
agam_int agam_abs_diff(agam_int __p0, agam_int __p1);
agam_int agam_motion_est_checksum(agam_int __p0);
...
block_3:
  ...
  agam_int __v10 = __v8 - __v9;
  return __v10;
block_5:
  agam_int __v11 = _local_b;
  agam_int __v12 = _local_a;
  agam_int __v13 = __v11 - __v12;
  return __v13;
}
...
block_8:
  ...
  agam_int _local_block_size = 0;
  agam_int __v24 = 0;
  agam_int __v26 = 8;
  _local_block_size = __v26;
  agam_int __v27 = __v26;
  agam_int _local_search_range = 0;
  agam_int __v28 = 0;
  agam_int __v30 = 4;
  _local_search_range = __v30;
  agam_int __v31 = __v30;
  agam_int _local_checksum = 0;
  agam_int __v32 = 0;
  agam_int __v34 = 0;
  _local_checksum = __v34;
  ...
  goto block_9;
block_9:
  agam_int __v40 = _local_f;
  agam_int __v41 = _local_frames;
  agam_bool __v42 = __v40 < __v41;
  if (__v42) goto block_10; else goto block_11;
block_10:
  agam_int _local_by = 0;
  agam_int __v43 = 0;
  agam_int __v45 = 0;
  _local_by = __v45;
  ...
  goto block_12;
block_12:
  agam_int __v47 = _local_by;
  agam_int __v48 = _local_height;
  agam_int __v49 = _local_block_size;
  agam_int __v50 = __v48 / __v49;
  agam_bool __v51 = __v47 < __v50;
  if (__v51) goto block_13; else goto block_14;
block_13:
  agam_int _local_bx = 0;
  agam_int __v52 = 0;
  agam_int __v54 = 0;
  _local_bx = __v54;
  ...
  goto block_15;
block_15:
  agam_int __v56 = _local_bx;
  agam_int __v57 = _local_width;
  agam_int __v58 = _local_block_size;
  agam_int __v59 = __v57 / __v58;
  agam_bool __v60 = __v56 < __v59;
  if (__v60) goto block_16; else goto block_17;
block_16:
  agam_int _local_best_sad = 0;
  agam_int __v61 = 0;
  agam_int __v63 = 999999999;
  _local_best_sad = __v63;
  agam_int __v64 = __v63;
  agam_int _local_best_dy = 0;
  agam_int __v65 = 0;
  agam_int __v67 = 0;
  _local_best_dy = __v67;
  agam_int __v68 = __v67;
  agam_int _local_best_dx = 0;
  agam_int __v69 = 0;
  agam_int __v71 = 0;
  _local_best_dx = __v71;
  agam_int __v72 = __v71;
  agam_int _local_dy = 0;
  agam_int __v73 = 0;
  agam_int __v74 = _local_search_range;
  agam_int __v75 = -__v74;
  _local_dy = __v75;
  agam_int __v76 = __v75;
  goto block_18;
block_18:
  agam_int __v77 = _local_dy;
  agam_int __v78 = _local_search_range;
  agam_bool __v79 = __v77 <= __v78;
  if (__v79) goto block_19; else goto block_20;
block_19:
  agam_int _local_dx = 0;
  agam_int __v80 = 0;
  agam_int __v81 = _local_search_range;
  agam_int __v82 = -__v81;
  _local_dx = __v82;
  agam_int __v83 = __v82;
  goto block_21;
block_21:
  agam_int __v84 = _local_dx;
  agam_int __v85 = _local_search_range;
  agam_bool __v86 = __v84 <= __v85;
  if (__v86) goto block_22; else goto block_23;
block_22:
  agam_int _local_sad = 0;
  agam_int __v87 = 0;
  agam_int __v89 = 0;
  _local_sad = __v89;
  ...
  agam_int __v93 = 0;
  _local_r = __v93;
  agam_int __v94 = __v93;
  goto block_24;
block_24:
  agam_int __v95 = _local_r;
  agam_int __v96 = _local_block_size;
  agam_bool __v97 = __v95 < __v96;
  if (__v97) goto block_25; else goto block_26;
block_25:
  agam_int _local_c = 0;
  agam_int __v98 = 0;
  agam_int __v100 = 0;
  ...
  goto block_27;
block_27:
  agam_int __v102 = _local_c;
  agam_int __v103 = _local_block_size;
  agam_bool __v104 = __v102 < __v103;
  if (__v104) goto block_28; else goto block_29;
block_28:
  agam_int _local_cy = 0;
  agam_int __v105 = 0;
  agam_int __v106 = _local_by;
  agam_int __v107 = _local_block_size;
  agam_int __v108 = __v106 * __v107;
  agam_int __v109 = _local_r;
  agam_int __v110 = __v108 + __v109;
  _local_cy = __v110;
  agam_int __v111 = __v110;
  agam_int _local_cx = 0;
  agam_int __v112 = 0;
  agam_int __v113 = _local_bx;
  agam_int __v114 = _local_block_size;
  agam_int __v115 = __v113 * __v114;
  agam_int __v116 = _local_c;
  agam_int __v117 = __v115 + __v116;
  _local_cx = __v117;
  agam_int __v118 = __v117;
  agam_int _local_ry = 0;
  agam_int __v119 = 0;
  agam_int __v120 = _local_cy;
  agam_int __v121 = _local_dy;
  agam_int __v122 = __v120 + __v121;
  _local_ry = __v122;
  agam_int __v123 = __v122;
  agam_int _local_rx = 0;
  agam_int __v124 = 0;
  agam_int __v125 = _local_cx;
  agam_int __v126 = _local_dx;
  agam_int __v127 = __v125 + __v126;
  _local_rx = __v127;
  agam_int __v128 = __v127;
  agam_int _local_cur_pixel = 0;
  agam_int __v129 = 0;
  agam_int __v130 = _local_f;
  agam_int __v131 = _local_width;
  agam_int __v132 = __v130 * __v131;
  agam_int __v133 = _local_height;
  agam_int __v134 = __v132 * __v133;
  agam_int __v135 = _local_cy;
  agam_int __v136 = _local_width;
  agam_int __v137 = __v135 * __v136;
  agam_int __v138 = __v134 + __v137;
  agam_int __v139 = _local_cx;
  agam_int __v140 = __v138 + __v139;
  agam_int __v142 = 17;
  ...
  _local_cur_pixel = __v149;
  agam_int __v150 = __v149;
  agam_int _local_ref_pixel = 0;
  agam_int __v151 = 0;
  agam_int __v153 = 0;
  _local_ref_pixel = __v153;
  agam_int __v154 = __v153;
  agam_int __v155 = _local_ry;
  agam_int __v157 = 0;
  agam_bool __v158 = __v155 >= __v157;
  agam_int __v159 = _local_ry;
  agam_int __v160 = _local_height;
  agam_bool __v161 = __v159 < __v160;
  agam_bool __v162 = __v158 && __v161;
  agam_int __v163 = _local_rx;
  agam_int __v165 = 0;
  agam_bool __v166 = __v163 >= __v165;
  agam_bool __v167 = __v162 && __v166;
  agam_int __v168 = _local_rx;
  agam_int __v169 = _local_width;
  agam_bool __v170 = __v168 < __v169;
  agam_bool __v171 = __v167 && __v170;
  if (__v171) goto block_30; else goto block_32;
block_30:
  agam_int __v172 = _local_f;
  agam_int __v174 = 1;
  agam_int __v175 = __v172 - __v174;
  agam_int __v176 = _local_width;
  agam_int __v177 = __v175 * __v176;
  agam_int __v178 = _local_height;
  agam_int __v179 = __v177 * __v178;
  agam_int __v180 = _local_ry;
  agam_int __v181 = _local_width;
  agam_int __v182 = __v180 * __v181;
  agam_int __v183 = __v179 + __v182;
  agam_int __v184 = _local_rx;
  ...
  _local_ref_pixel = __v194;
  agam_int __v195 = __v194;
  goto block_32;
block_32:
  agam_int __v196 = _local_sad;
  agam_int __v197 = _local_cur_pixel;
  agam_int __v198 = _local_ref_pixel;
  agam_int __v199 = agam_abs_diff(__v197, __v198);
  agam_int __v200 = __v196 + __v199;
  _local_sad = __v200;
  agam_int __v201 = __v200;
  agam_int __v202 = _local_c;
  agam_int __v204 = 1;
  agam_int __v205 = __v202 + __v204;
  _local_c = __v205;
  agam_int __v206 = __v205;
  goto block_27;
block_29:
  agam_int __v207 = _local_r;
  agam_int __v209 = 1;
  ...
  goto block_24;
block_26:
  agam_int __v212 = _local_sad;
  agam_int __v213 = _local_best_sad;
  agam_bool __v214 = __v212 < __v213;
  if (__v214) goto block_33; else goto block_35;
block_33:
  agam_int __v215 = _local_sad;
  _local_best_sad = __v215;
  agam_int __v216 = __v215;
  agam_int __v217 = _local_dy;
  _local_best_dy = __v217;
  agam_int __v218 = __v217;
  agam_int __v219 = _local_dx;
  _local_best_dx = __v219;
  agam_int __v220 = __v219;
  goto block_35;
block_35:
  agam_int __v221 = _local_dx;
  agam_int __v223 = 1;
...
block_23:
  ...
  goto block_18;
block_20:
  agam_int __v231 = _local_checksum;
  agam_int __v233 = 31;
  agam_int __v234 = __v231 * __v233;
  agam_int __v235 = _local_best_sad;
  agam_int __v236 = __v234 + __v235;
  agam_int __v237 = _local_best_dy;
  agam_int __v239 = 17;
  agam_int __v240 = __v237 * __v239;
  agam_int __v241 = __v236 + __v240;
  agam_int __v242 = _local_best_dx;
  agam_int __v244 = 7;
  agam_int __v245 = __v242 * __v244;
  agam_int __v246 = __v241 + __v245;
  agam_int __v248 = 1000000007;
  agam_int __v249 = __v246 % __v248;
  _local_checksum = __v249;
  agam_int __v250 = __v249;
  agam_int __v251 = _local_bx;
  agam_int __v253 = 1;
  agam_int __v254 = __v251 + __v253;
  _local_bx = __v254;
  agam_int __v255 = __v254;
  goto block_15;
block_17:
  agam_int __v256 = _local_by;
  agam_int __v258 = 1;
  ...
  goto block_12;
block_14:
  agam_int __v261 = _local_f;
  agam_int __v263 = 1;
  agam_int __v264 = __v261 + __v263;
  _local_f = __v264;
  agam_int __v265 = __v264;
  goto block_9;
block_11:
  agam_int __v266 = _local_checksum;
  return __v266;
}
...
block_37:
  agam_int __v269 = 8;
  agam_int __v270 = agam_motion_est_checksum(__v269);
  printf("%lld", (long long)__v270);
  printf("\n");
  agam_int __v271 = 0;
  agam_int __v272 = 0;
  return (int)__v272;
