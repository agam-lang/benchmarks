...
agam_int agam_compute(agam_int __p0);
...
block_7:
  agam_int __v36 = 10000;
  agam_int __v37 = agam_compute(__v36);
  printf("%lld", (long long)__v37);
  printf("\n");
  agam_int __v38 = 0;
  agam_int __v39 = 0;
  return (int)__v39;
