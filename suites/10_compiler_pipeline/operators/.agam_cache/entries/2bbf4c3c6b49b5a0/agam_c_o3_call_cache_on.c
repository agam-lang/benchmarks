...
agam_int agam_bool_to_int(agam_int __p0);
...
agam_int agam_bool_to_int(agam_int __p0) {
  agam_int _local_cond = __p0;
block_2:
  agam_int __v4 = _local_cond;
  return __v4;
}
...
block_20:
  ...
  goto block_22;
block_22:
  agam_int __v70 = _local_total;
  printf("%lld", (long long)__v70);
  printf("\n");
  agam_int __v71 = 0;
  agam_int __v72 = 0;
  return (int)__v72;
